...
client = OpenAI(api_key="zephyr-7b-beta")
...
# TODO: The 'openai.api_base' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(base_url="http://127.0.0.1:1234")'
...
def main() -> None:
    ...
    application = Application.builder().token("7782362027:AAFgTK6oYQjqvRyc7oc55P4HTe1B_Smoj50").build()
